...
Where $Y$ is the YoY difference in number of alcohol-related fatalities per 10k citizens, $\beta_0$ is the fixed effects for year and state, $\beta_1$ is the effect of YoY difference in beer taxes, $X_1$ is the YoY difference in beer taxes and $\epsilon$ is our error term.
