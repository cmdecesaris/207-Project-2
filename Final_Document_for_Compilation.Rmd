...
mtext("Diagnostics for Drinking Age", outer = TRUE, cex = 2)
Fatalities[112,]
Fatalities[211,]
...
datatable(stat,class = 'cell-border stripe',
 caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;',
    'Table X: ', htmltools::em('ANOVA: Alcohol-Related Traffic Fatalities in Northern Region')),options = list(sDom  = 't'), colnames= )
